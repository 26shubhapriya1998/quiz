$(document).ready(function(){
	...
	let questionBank=[
	{
		...
		id:1,
		answer:"New Delhi",
		options:['New Delhi','Hyderabad','chandigarh']
	},{
		...
		id:3,
		answer:"bengaluru",
		options:["srinagar","bengaluru","bhubaneshwar"]},
		{

		question:"what is the capital city of kerala?",
		id:4,
		answer:"thiruvananthapura",
		options:["coimbature","gandhinagar","thiruvananthapura"]
